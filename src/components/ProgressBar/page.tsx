    ...
    <div className='w-full px-10 py-5'>
      {totalNumOfExercises > 0 ? (
        <div className='h-4 w-full rounded-2xl bg-duoGray-default text-transparent dark:bg-duoGrayDark-light'>
          <div
            className='dark:bg-duoGreenDark-default relative flex h-full items-center justify-start rounded-2xl bg-duoGreen-default'
            style={{
              width: `${newwidth}%`,
          ...
          >
            <div className='mx-[10%] mb-[2.5px] w-[80%] sm:mx-[4%] sm:w-[92%] md:mx-2 md:w-full'>
              <div className='dark:bg-duoGreenDark-light max-h-[5px] w-full rounded-3xl bg-duoGreen-light'>
                {' '}
                {newwidth}
              </div>
            </div>
