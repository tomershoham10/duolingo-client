...
const PlusButton: React.FC<PlusButtonProps> = (props) => {
  ...
  return (
    <div
      className={`my-3 flex cursor-pointer flex-row items-center justify-start w-fit mx-auto ${
        !!label && 'group'
      }`}
    >
      <button
        className={`flex h-8 w-8 items-center justify-center rounded-full bg-duoGray-lighter text-2xl text-duoGrayDark-lightest dark:bg-duoGrayDark-light lg:h-9 lg:w-9 ${
          !!label
